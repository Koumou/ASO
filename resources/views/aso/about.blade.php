...
<div class="container">
    <div class="row pb-0">
        ...
        <div class="pt-4 col-lg-6  text-center align-self-center" style="margin-top: 20px;">
            ...
            <h1 class="h1gradient pt-4 " >ASO</h1>
        </div>
    </div>
    <br />
    ...
    <div class="row pt-4 pb-4">
        ...
        <div class="col-lg-5 pl-6">
            ...
            <div class="card ">
                <img src="https://t4.ftcdn.net/jpg/02/53/06/69/360_F_253066985_AnTreg13pWhIrVjBnEeOgH7CoCtj9u6A.jpg" style="width: 100%; max-width:100vw;max-height:unset;" alt="...">
    ...
    <div class="row pt-4 pb-4 flex-row-reverse">
        <div class="col-lg-5 pl-6">
            ...
            <div class="card ">
                ...
                <img src="https://i2.wp.com/cariblens.com/wp-content/uploads/2020/05/African-american-business-woman-by-the-window-Free-Photo.jpg" style="width: 100%; max-width:100vw;max-height:unset;" alt="...">
